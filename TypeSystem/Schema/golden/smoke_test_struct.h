...
struct Evolve<ExposedNamespace, ExposedNamespace::E, EVOLUTOR> {
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Empty, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::FullTest, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::FullTest& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::FullTest>::value == 13,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.primitives), EVOLUTOR>::template Go<INTO>(from.primitives, into.primitives);
      Evolve<ExposedNamespace, decltype(from.v1), EVOLUTOR>::template Go<INTO>(from.v1, into.v1);
      Evolve<ExposedNamespace, decltype(from.v2), EVOLUTOR>::template Go<INTO>(from.v2, into.v2);
      Evolve<ExposedNamespace, decltype(from.p), EVOLUTOR>::template Go<INTO>(from.p, into.p);
      Evolve<ExposedNamespace, decltype(from.o), EVOLUTOR>::template Go<INTO>(from.o, into.o);
      Evolve<ExposedNamespace, decltype(from.q), EVOLUTOR>::template Go<INTO>(from.q, into.q);
      Evolve<ExposedNamespace, decltype(from.w1), EVOLUTOR>::template Go<INTO>(from.w1, into.w1);
      Evolve<ExposedNamespace, decltype(from.w2), EVOLUTOR>::template Go<INTO>(from.w2, into.w2);
      Evolve<ExposedNamespace, decltype(from.w3), EVOLUTOR>::template Go<INTO>(from.w3, into.w3);
      Evolve<ExposedNamespace, decltype(from.w4), EVOLUTOR>::template Go<INTO>(from.w4, into.w4);
      Evolve<ExposedNamespace, decltype(from.w5), EVOLUTOR>::template Go<INTO>(from.w5, into.w5);
      Evolve<ExposedNamespace, decltype(from.w6), EVOLUTOR>::template Go<INTO>(from.w6, into.w6);
      Evolve<ExposedNamespace, decltype(from.tsc), EVOLUTOR>::template Go<INTO>(from.tsc, into.tsc);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::B, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::B& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::B>::value == 1,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, ExposedNamespace::A, EVOLUTOR>::template Go<INTO>(static_cast<const typename ExposedNamespace::A&>(from), static_cast<typename INTO::A&>(into));
      Evolve<ExposedNamespace, decltype(from.b), EVOLUTOR>::template Go<INTO>(from.b, into.b);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Templated_T9209626390174323094, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::Templated_T9209626390174323094& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::Templated_T9209626390174323094>::value == 2,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.foo), EVOLUTOR>::template Go<INTO>(from.foo, into.foo);
      Evolve<ExposedNamespace, decltype(from.bar), EVOLUTOR>::template Go<INTO>(from.bar, into.bar);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Templated_T9200000002835747520, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::C, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::C& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::C>::value == 3,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.e), EVOLUTOR>::template Go<INTO>(from.e, into.e);
      Evolve<ExposedNamespace, decltype(from.c), EVOLUTOR>::template Go<INTO>(from.c, into.c);
      Evolve<ExposedNamespace, decltype(from.d), EVOLUTOR>::template Go<INTO>(from.d, into.d);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::TrickyEvolutionCases, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::TrickyEvolutionCases& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::TrickyEvolutionCases>::value == 7,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.o1), EVOLUTOR>::template Go<INTO>(from.o1, into.o1);
      Evolve<ExposedNamespace, decltype(from.o2), EVOLUTOR>::template Go<INTO>(from.o2, into.o2);
      Evolve<ExposedNamespace, decltype(from.o3), EVOLUTOR>::template Go<INTO>(from.o3, into.o3);
      Evolve<ExposedNamespace, decltype(from.o4), EVOLUTOR>::template Go<INTO>(from.o4, into.o4);
      Evolve<ExposedNamespace, decltype(from.o5), EVOLUTOR>::template Go<INTO>(from.o5, into.o5);
      Evolve<ExposedNamespace, decltype(from.o6), EVOLUTOR>::template Go<INTO>(from.o6, into.o6);
      Evolve<ExposedNamespace, decltype(from.o7), EVOLUTOR>::template Go<INTO>(from.o7, into.o7);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::TemplatedInheriting_T9201673071807149456, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::TemplatedInheriting_T9201673071807149456& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::TemplatedInheriting_T9201673071807149456>::value == 2,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, ExposedNamespace::A, EVOLUTOR>::template Go<INTO>(static_cast<const typename ExposedNamespace::A&>(from), static_cast<typename INTO::A&>(into));
      Evolve<ExposedNamespace, decltype(from.baz), EVOLUTOR>::template Go<INTO>(from.baz, into.baz);
      Evolve<ExposedNamespace, decltype(from.meh), EVOLUTOR>::template Go<INTO>(from.meh, into.meh);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::A, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::A& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::A>::value == 1,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.a), EVOLUTOR>::template Go<INTO>(from.a, into.a);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Primitives, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::Primitives& from,
      ...
      Evolve<ExposedNamespace, decltype(from.d), EVOLUTOR>::template Go<INTO>(from.d, into.d);
      Evolve<ExposedNamespace, decltype(from.e), EVOLUTOR>::template Go<INTO>(from.e, into.e);
      Evolve<ExposedNamespace, decltype(from.f), EVOLUTOR>::template Go<INTO>(from.f, into.f);
      Evolve<ExposedNamespace, decltype(from.g), EVOLUTOR>::template Go<INTO>(from.g, into.g);
      Evolve<ExposedNamespace, decltype(from.h), EVOLUTOR>::template Go<INTO>(from.h, into.h);
      Evolve<ExposedNamespace, decltype(from.i), EVOLUTOR>::template Go<INTO>(from.i, into.i);
      Evolve<ExposedNamespace, decltype(from.j), EVOLUTOR>::template Go<INTO>(from.j, into.j);
      Evolve<ExposedNamespace, decltype(from.k), EVOLUTOR>::template Go<INTO>(from.k, into.k);
      Evolve<ExposedNamespace, decltype(from.l), EVOLUTOR>::template Go<INTO>(from.l, into.l);
      Evolve<ExposedNamespace, decltype(from.m), EVOLUTOR>::template Go<INTO>(from.m, into.m);
      Evolve<ExposedNamespace, decltype(from.n), EVOLUTOR>::template Go<INTO>(from.n, into.n);
      Evolve<ExposedNamespace, decltype(from.o), EVOLUTOR>::template Go<INTO>(from.o, into.o);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::TemplatedInheriting_T9209980946934124423, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Y, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Templated_T9209980946934124423, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::TemplatedInheriting_T9227782344077896555, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::TemplatedInheriting_T9200000002835747520, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::B2, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::Templated_T9227782344077896555, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, typename ExposedNamespace::X, EVOLUTOR> {
  template <typename INTO>
  static void Go(const typename ExposedNamespace::X& from,
      ...
      static_assert(::current::reflection::FieldCounter<typename INTO::X>::value == 1,
                    "Custom evolutor required.");
      Evolve<ExposedNamespace, decltype(from.x), EVOLUTOR>::template Go<INTO>(from.x, into.x);
  }
};
#endif
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, Optional<typename ExposedNamespace::A>, EVOLUTOR> {
  ...
  static void Go(const Optional<typename ExposedNamespace::A>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      ...
      Evolve<ExposedNamespace, typename ExposedNamespace::A, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, Optional<typename ExposedNamespace::Primitives>, EVOLUTOR> {
  template <typename INTO, typename INTO_TYPE>
  static void Go(const Optional<typename ExposedNamespace::Primitives>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      typename INTO::Primitives evolved;
      Evolve<ExposedNamespace, typename ExposedNamespace::Primitives, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, Optional<std::vector<typename ExposedNamespace::A>>, EVOLUTOR> {
  template <typename INTO, typename INTO_TYPE>
  static void Go(const Optional<std::vector<typename ExposedNamespace::A>>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      ...
      Evolve<ExposedNamespace, std::vector<typename ExposedNamespace::A>, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, Optional<std::vector<int32_t>>, EVOLUTOR> {
  template <typename INTO, typename INTO_TYPE>
  static void Go(const Optional<std::vector<int32_t>>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      std::vector<int32_t> evolved;
      Evolve<ExposedNamespace, std::vector<int32_t>, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
template <typename EVOLUTOR>
struct Evolve<ExposedNamespace, Optional<std::vector<std::string>>, EVOLUTOR> {
  template <typename INTO, typename INTO_TYPE>
  static void Go(const Optional<std::vector<std::string>>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      std::vector<std::string> evolved;
      Evolve<ExposedNamespace, std::vector<std::string>, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
struct Evolve<ExposedNamespace, ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<ExposedNamespace::A, ExposedNamespace::X, ExposedNamespace::Y>>, EVOLUTOR> {
  template <typename INTO,
  ...
  static void Go(const ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<ExposedNamespace::A, ExposedNamespace::X, ExposedNamespace::Y>>& from,
    ...
    from.Call(ExposedNamespace_MyFreakingVariant_Cases<decltype(into), ExposedNamespace, INTO, EVOLUTOR>(into));
  }
};
#endif
...
template <typename EVOLUTOR, typename VARIANT_NAME_HELPER>
struct Evolve<ExposedNamespace, ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<ExposedNamespace::A, ExposedNamespace::B, ExposedNamespace::B2, ExposedNamespace::C, ExposedNamespace::Empty>>, EVOLUTOR> {
  template <typename INTO,
            typename CUSTOM_INTO_VARIANT_TYPE>
  static void Go(const ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<ExposedNamespace::A, ExposedNamespace::B, ExposedNamespace::B2, ExposedNamespace::C, ExposedNamespace::Empty>>& from,
                 CUSTOM_INTO_VARIANT_TYPE& into) {
    from.Call(ExposedNamespace_Variant_B_A_B_B2_C_Empty_E_Cases<decltype(into), ExposedNamespace, INTO, EVOLUTOR>(into));
  }
};
#endif
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Empty, {
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, FullTest, {
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, B, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.b, into.b);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Templated_T9209626390174323094, {
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Templated_T9200000002835747520, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.foo, into.foo);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.bar, into.bar);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, C, {
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, TrickyEvolutionCases, {
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, TemplatedInheriting_T9201673071807149456, {
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, A, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.a, into.a);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Primitives, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.a, into.a);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.b, into.b);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.c, into.c);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.d, into.d);
...
CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, TemplatedInheriting_T9209980946934124423, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.baz, into.baz);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.meh, into.meh);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Y, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.e, into.e);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Templated_T9209980946934124423, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.foo, into.foo);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.bar, into.bar);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, TemplatedInheriting_T9227782344077896555, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.baz, into.baz);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.meh, into.meh);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, TemplatedInheriting_T9200000002835747520, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.baz, into.baz);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.meh, into.meh);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, B2, {
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, Templated_T9227782344077896555, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.foo, into.foo);
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.bar, into.bar);
});

CURRENT_TYPE_EVOLUTOR(CustomEvolutor, ExposedNamespace, X, {
  CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from.x, into.x);
});

CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, ExposedNamespace, t9227782344077896555::MyFreakingVariant, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206911749438269255::A, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9209980946934124423::X, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9208828720332602574::Y, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
};

CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, ExposedNamespace, t9227782347108675041::Variant_B_A_X_Y_E, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206911749438269255::A, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9209980946934124423::X, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9208828720332602574::Y, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
};

CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, ExposedNamespace, t9228482442669086788::Variant_B_A_B_B2_C_Empty_E, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206911749438269255::A, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9200817599233955266::B, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9209827283478105543::B2, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9202971611369570493::C, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9200000002835747520::Empty, CURRENT_NATURAL_EVOLVE(ExposedNamespace, CustomDestinationNamespace, from, into));
};
