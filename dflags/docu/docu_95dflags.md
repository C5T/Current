...
Bricks has [`dflags`](http://www.google.com): a C++ library to parse command-line flags.
...
[`dflags`](http://www.google.com) is a simplified header-only version of Google's [`gflags`](http://www.google.com). It requires no linker dependencies and largely is backwards-compatible.
