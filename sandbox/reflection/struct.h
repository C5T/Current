...
#define CURRENT_FIELD_REFLECTION(idx, type, name)                                                            \
  ...
  template <class F>                                                                                         \
  void CURRENT_REFLECTION(F&& f, ::bricks::reflection::Index<::bricks::reflection::FieldValue, idx>) const { \
    f(name);                                                                                                 \
  }                                                                                                          \
  template <class F>                                                                                         \
  void CURRENT_REFLECTION(                                                                                   \
      F&& f, ::bricks::reflection::Index<::bricks::reflection::FieldNameAndImmutableValueReference, idx>)    \
      const {                                                                                                \
    f(#name, name);                                                                                          \
  }                                                                                                          \
  template <class F>                                                                                         \
...
#define CURRENT_STRUCT_IS_VALID(s)                                                                    \
  ::bricks::reflection::CurrentStructFieldsConsistency<s,                                             \
                                                       ::bricks::reflection::FieldCounter<s>::value - \
                                                           1>::Check()
