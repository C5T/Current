...
* *3/4/2015* : **1.0, Initial public release.**
  ...
  [README](https://github.com/dkorolev/Bricks/tree/mac_full_build#documentation),
  [tar.gz](https://github.com/dkorolev/Bricks/archive/mac_full_build.tar.gz),
  [zip](https://github.com/dkorolev/Bricks/archive/mac_full_build.zip).
