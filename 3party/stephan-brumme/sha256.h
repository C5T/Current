// Code by Stephan Brumme from http://create.stephan-brumme.com/hash-library
//
//   Stephan Brumme
...
//
// Released by Stephan Brumme under zlip license: http://create.stephan-brumme.com/disclaimer.html
...
#ifndef STEPHAN_BRUMME_SHA256_H
#define STEPHAN_BRUMME_SHA256_H
...
public:
  ...
  // Added by @dkorolev -- D.K.
  operator std::string() {
    return getHash();
  }
  SHA256(const std::string& s) : SHA256() {
...
}  // sha256_impl_by_StephanBrumme

#endif  //  STEPHAN_BRUMME_SHA256_H
