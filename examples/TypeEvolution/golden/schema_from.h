...
struct Evolve<From, typename From::WithExpandingVariant, EVOLUTOR> {
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::FullName, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::CustomTypeB, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::Basic, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::TopLevel, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::WithShrinkingVariant, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::WithFieldsToRemove, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::CustomTypeA, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::CustomTypeC, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, typename From::WithOptional, EVOLUTOR> {
  template <typename INTO>
...
template <typename EVOLUTOR>
struct Evolve<From, Optional<typename From::FullName>, EVOLUTOR> {
  ...
  static void Go(const Optional<typename From::FullName>& from, INTO_TYPE& into) {
    if (Exists(from)) {
      ...
      Evolve<From, typename From::FullName, EVOLUTOR>::template Go<INTO>(Value(from), evolved);
      into = evolved;
    } else {
      into = nullptr;
    }
...
struct Evolve<From, ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::CustomTypeA, From::CustomTypeB>>, EVOLUTOR> {
  template <typename INTO,
  ...
  static void Go(const ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::CustomTypeA, From::CustomTypeB>>& from,
    ...
    from.Call(From_ExpandingVariant_Cases<decltype(into), From, INTO, EVOLUTOR>(into));
  }
};
#endif
...
template <typename EVOLUTOR, typename VARIANT_NAME_HELPER>
struct Evolve<From, ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::CustomTypeA, From::CustomTypeB, From::CustomTypeC>>, EVOLUTOR> {
  template <typename INTO,
            typename CUSTOM_INTO_VARIANT_TYPE>
  static void Go(const ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::CustomTypeA, From::CustomTypeB, From::CustomTypeC>>& from,
                 CUSTOM_INTO_VARIANT_TYPE& into) {
    from.Call(From_ShrinkingVariant_Cases<decltype(into), From, INTO, EVOLUTOR>(into));
  }
};
#endif
...
template <typename EVOLUTOR, typename VARIANT_NAME_HELPER>
struct Evolve<From, ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::Basic, From::FullName, From::WithOptional, From::WithExpandingVariant, From::WithShrinkingVariant, From::WithFieldsToRemove>>, EVOLUTOR> {
  template <typename INTO,
            typename CUSTOM_INTO_VARIANT_TYPE>
  static void Go(const ::current::VariantImpl<VARIANT_NAME_HELPER, TypeListImpl<From::Basic, From::FullName, From::WithOptional, From::WithExpandingVariant, From::WithShrinkingVariant, From::WithFieldsToRemove>>& from,
                 CUSTOM_INTO_VARIANT_TYPE& into) {
    from.Call(From_All_Cases<decltype(into), From, INTO, EVOLUTOR>(into));
  }
};
#endif
...
CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, From, t9221067729821834539::ExpandingVariant, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206911750362052937::CustomTypeA, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9202573820625447155::CustomTypeB, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
};

CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, From, t9226317599863657099::ShrinkingVariant, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206911750362052937::CustomTypeA, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9202573820625447155::CustomTypeB, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9207934621170686053::CustomTypeC, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
};

CURRENT_TYPE_EVOLUTOR_VARIANT(CustomEvolutor, From, t9227074222822990824::All, CustomDestinationNamespace) {
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9203341832538601265::Basic, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9201952458119363219::FullName, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9209615657629583566::WithOptional, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9201009161779005289::WithExpandingVariant, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9205425707876881313::WithShrinkingVariant, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
  CURRENT_TYPE_EVOLUTOR_NATURAL_VARIANT_CASE(t9206820554754825223::WithFieldsToRemove, CURRENT_NATURAL_EVOLVE(From, CustomDestinationNamespace, from, into));
};
