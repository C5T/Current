#ifndef RAPIDJSON_CEREAL_DOCUMENT_H_
#define RAPIDJSON_CEREAL_DOCUMENT_H_
...
public:
	...
	*/
	GenericValue(Type type) {
		...
		RAPIDJSON_CEREAL_ASSERT(type <= kNumberType);
	...
	GenericValue(const Ch* s, SizeType length) {
		RAPIDJSON_CEREAL_ASSERT(s != NULL);
	...
	*/
	GenericValue& operator=(GenericValue& rhs) {
		RAPIDJSON_CEREAL_ASSERT(this != &rhs);
		this->~GenericValue();
	...
	*/
	...
	bool GetBool_() const { RAPIDJSON_CEREAL_ASSERT(IsBool_()); return flags_ == kTrueFlag; }
	...
	//! Member iterators.
	ConstMemberIterator MemberBegin() const	{ RAPIDJSON_CEREAL_ASSERT(IsObject()); return data_.o.members; }
	ConstMemberIterator MemberEnd()	const	{ RAPIDJSON_CEREAL_ASSERT(IsObject()); return data_.o.members + data_.o.size; }
	MemberIterator MemberBegin()			{ RAPIDJSON_CEREAL_ASSERT(IsObject()); return data_.o.members; }
	MemberIterator MemberEnd()				{ RAPIDJSON_CEREAL_ASSERT(IsObject()); return data_.o.members + data_.o.size; }
	...
	*/
	GenericValue& AddMember(GenericValue& name, GenericValue& value, Allocator& allocator) {
		RAPIDJSON_CEREAL_ASSERT(IsObject());
		RAPIDJSON_CEREAL_ASSERT(name.IsString());
		Object& o = data_.o;
	...
	*/
	bool RemoveMember(const Ch* name) {
		...
		if (Member* m = FindMember(name)) {
			RAPIDJSON_CEREAL_ASSERT(data_.o.size > 0);
			RAPIDJSON_CEREAL_ASSERT(data_.o.members != 0);
	...
	SizeType Size() const { RAPIDJSON_CEREAL_ASSERT(IsArray()); return data_.a.size; }

	//! Get the capacity of array.
	SizeType Capacity() const { RAPIDJSON_CEREAL_ASSERT(IsArray()); return data_.a.capacity; }

	//! Check whether the array is empty.
	bool Empty() const { RAPIDJSON_CEREAL_ASSERT(IsArray()); return data_.a.size == 0; }

	//! Remove all elements in the array.
	/*! This function do not deallocate memory in the array, i.e. the capacity is unchanged.
	*/
	void Clear() {
		RAPIDJSON_CEREAL_ASSERT(IsArray());
...
\endcode
	*/
	GenericValue& operator[](SizeType index) {
		RAPIDJSON_CEREAL_ASSERT(IsArray());
		RAPIDJSON_CEREAL_ASSERT(index < data_.a.size);
		return data_.a.elements[index];
	}
	const GenericValue& operator[](SizeType index) const { return const_cast<GenericValue&>(*this)[index]; }

	//! Element iterator
	ValueIterator Begin() { RAPIDJSON_CEREAL_ASSERT(IsArray()); return data_.a.elements; }
	ValueIterator End() { RAPIDJSON_CEREAL_ASSERT(IsArray()); return data_.a.elements + data_.a.size; }
	...
	*/
	...
	int GetInt() const			{ RAPIDJSON_CEREAL_ASSERT(flags_ & kIntFlag);   return data_.n.i.i;   }
	unsigned GetUint() const	{ RAPIDJSON_CEREAL_ASSERT(flags_ & kUintFlag);  return data_.n.u.u;   }
	int64_t GetInt64() const	{ RAPIDJSON_CEREAL_ASSERT(flags_ & kInt64Flag); return data_.n.i64; }
	uint64_t GetUint64() const	{ RAPIDJSON_CEREAL_ASSERT(flags_ & kUint64Flag); return data_.n.u64; }

	double GetDouble() const {
		RAPIDJSON_CEREAL_ASSERT(IsNumber());
		if ((flags_ & kDoubleFlag) != 0)				return data_.n.d;	// exact type, no conversion.
		if ((flags_ & kIntFlag) != 0)					return data_.n.i.i;	// int -> double
		if ((flags_ & kUintFlag) != 0)					return data_.n.u.u;	// unsigned -> double
		if ((flags_ & kInt64Flag) != 0)					return (double)data_.n.i64; // int64_t -> double (may lose precision)
		RAPIDJSON_CEREAL_ASSERT((flags_ & kUint64Flag) != 0);	return (double)data_.n.u64;	// uint64_t -> double (may lose precision)
	}
	...
	const Ch* GetString() const { RAPIDJSON_CEREAL_ASSERT(IsString()); return data_.s.str; }

	//! Get the length of string.
	/*! Since rapidjson permits "\u0000" in the json string, strlen(v.GetString()) may not equal to v.GetStringLength().
	*/
	SizeType GetStringLength() const { RAPIDJSON_CEREAL_ASSERT(IsString()); return data_.s.length; }
...
private:
	...
	union Number {
#if RAPIDJSON_CEREAL_ENDIAN == RAPIDJSON_CEREAL_LITTLEENDIAN
		struct I {
			int i;
			char padding[4];
		}i;
...
public:
	...
	*/
	...
	GenericDocument& ParseStream(Stream& stream) {
		...
		if (reader.template Parse<parseFlags>(stream, *this)) {
			RAPIDJSON_CEREAL_ASSERT(stack_.GetSize() == sizeof(ValueType)); // Got one and only one root object
	...
	*/
	...
	GenericDocument& Parse(const Ch* str) {
		RAPIDJSON_CEREAL_ASSERT(!(parseFlags & kParseInsituFlag));
...
#endif // RAPIDJSON_CEREAL_DOCUMENT_H_
